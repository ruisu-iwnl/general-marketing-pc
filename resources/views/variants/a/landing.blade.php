        ...
        <section class="content-section">
            <div class="section-inner">
                ...
                <div class="free-class-cta">
                    <img src="{{ asset('landing/notebook.png') }}" alt="notebook" class="notebook-image">
                    <a class="free-class-button" href="https://m.pweng.net/level-test.php" target="_blank" rel="noopener">무료수업 신청하기</a>
                </div>
