...
<body id="top">
    ...
    <section class="content-section">
        <div class="section-inner">
            ...
            <a href="#lead-form" class="cta-button">무료수업 신청하기</a>
        </div>
    </section>
    ...
    <section id="lead-form" class="lead-form-section">
        <div class="lead-form-inner">
            <h2>무료 수업 신청</h2>
            <p class="subtitle">이름과 연락처를 남겨주시면 빠르게 안내드리겠습니다.</p>

            <form id="leadForm" method="POST" action="{{ url('/lead') }}">
                @csrf
                ...
                <input type="text" id="name" name="name" placeholder="이름을 입력해주세요" required minlength="2">
                <div class="error-msg" id="name-error">이름을 2글자 이상 입력해주세요.</div>

                <label for="phone">연락처</label>
                <input type="tel" id="phone" name="phone" placeholder="010-0000-0000" required>
                <div class="error-msg" id="phone-error">올바른 연락처를 입력해주세요.</div>

                <div class="privacy-check">
                    <input type="checkbox" id="privacy" name="privacy" required>
                    <label for="privacy" style="margin-bottom: 0; font-size: 13px; font-weight: 300;">
                        <a href="#" onclick="event.preventDefault(); document.getElementById('privacy-modal-overlay').classList.remove('opacity-0','pointer-events-none');">개인정보 수집 및 이용</a>에 동의합니다.
                    </label>
                </div>

                <button type="submit" class="submit-btn" id="submitBtn">무료수업 신청하기</button>
            </form>
        </div>
    </section>
    ...
    {{-- 개인정보처리방침 모달 --}}
    <div id="privacy-modal-overlay" class="fixed inset-0 z-[120] flex items-center justify-center p-4 opacity-0 pointer-events-none" style="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:120;display:flex;align-items:center;justify-content:center;padding:16px;opacity:0;pointer-events:none;transition:opacity 0.3s;">
        <div id="privacy-modal" style="background:#fff;border-radius:16px;box-shadow:0 25px 50px rgba(0,0,0,0.25);max-width:640px;width:100%;max-height:80vh;overflow:hidden;transform:scale(0.95);transition:transform 0.3s;">
            <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 24px;border-bottom:1px solid #f0f0f0;">
                <h3 style="font-size:18px;font-weight:700;color:#111;margin:0;">개인정보 수집 및 이용 동의</h3>
                <button onclick="var o=document.getElementById('privacy-modal-overlay');o.style.opacity='0';o.style.pointerEvents='none';" style="background:none;border:none;cursor:pointer;color:#999;font-size:24px;">&times;</button>
            </div>
            <div style="padding:20px 24px;overflow-y:auto;max-height:60vh;font-size:14px;color:#666;line-height:1.7;">
                <p style="margin-bottom:16px;"><strong style="color:#111;">1. 수집하는 개인정보 항목</strong></p>
                <p style="margin-bottom:16px;padding-left:16px;">- 필수항목: 이름, 연락처(휴대폰 번호)<br>- 자동수집항목: 접속 IP, 방문 일시, 서비스 이용 기록</p>
                <p style="margin-bottom:16px;"><strong style="color:#111;">2. 개인정보 수집 및 이용 목적</strong></p>
                <p style="margin-bottom:16px;padding-left:16px;">- 무료 수업 서비스 제공 및 상담 연락<br>- 서비스 이용에 따른 본인 확인</p>
                <p style="margin-bottom:16px;"><strong style="color:#111;">3. 개인정보 보유 및 이용 기간</strong></p>
                <p style="margin-bottom:16px;padding-left:16px;">- 수집일로부터 1년간 보관 후 파기<br>- 단, 관련 법령에 의해 보존이 필요한 경우 해당 기간 동안 보관</p>
                <p style="margin-bottom:16px;"><strong style="color:#111;">4. 동의 거부권 및 불이익</strong></p>
                <p style="margin-bottom:16px;padding-left:16px;">귀하는 개인정보 수집&middot;이용에 대한 동의를 거부할 권리가 있습니다. 다만, 필수항목에 대한 동의를 거부하실 경우 무료 수업 서비스 이용이 제한될 수 있습니다.</p>
                <p style="margin-bottom:16px;"><strong style="color:#111;">5. 개인정보 제3자 제공</strong></p>
                <p style="padding-left:16px;">수집된 개인정보는 제3자에게 제공되지 않습니다.</p>
            </div>
            <div style="padding:16px 24px;border-top:1px solid #f0f0f0;background:#fafafa;">
                <button onclick="var o=document.getElementById('privacy-modal-overlay');o.style.opacity='0';o.style.pointerEvents='none';" style="width:100%;padding:12px;background:#FF3D5C;color:#fff;border:none;border-radius:12px;font-size:16px;font-weight:600;cursor:pointer;">확인</button>
            </div>
        </div>
    </div>
    ...
    (function() {
        var tracked = false;
        document.querySelectorAll('.cta-button').forEach(function(link) {
            link.addEventListener('click', function() {
                if (tracked) return;
                tracked = true;
                var data = new FormData();
                data.append('variant', '{{ $variant }}');
                data.append('button_type', 'cta-button');
