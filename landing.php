...
<body id="top">
    <header class="promo-banner">
        <a href="#">
            <!-- 지금 레벨테스트하고 <span class="highlight">1,000</span>원 쿠폰 받자! <span class="arrow">></span> -->
            무료 레벨테스트 받고 강사평가 남기면 <span class="highlight"></span>1,OOO</span>원 쿠폰 즉시 적립! <span class="arrow"></span>
        </a>
    </header>
    ...
    <section class="hero-section">
        <div class="hero-wrapper">
            <img src="resources/lp-gen-img-1-1.png" alt="Hero background" class="hero-bg">
            <div class="hero-content">
                ...
                <div class="hero-image">
                    <img src="resources/lp-gen-img-1-0.png" alt="매일영 챌린지">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="content-section bg-gray">
        <div class="section-inner">
            ...
            <img src="resources/sect-09-01.png" alt="" class="spec-image">
            <img src="resources/sect-09-02.png" alt="" class="spec-image">
            <img src="resources/sect-09-03.png" alt="" class="spec-image">
        </div>
    </section>
    ...
    <section class="content-section bg-gray">
        <div class="section-inner">
            ...
            <p>가능합니다.</p>
            <p>매일영 챌린지는 고정 시간 출석이나 예약 수업이 없습니다.<br>하루 중 본인이 가능한 시간에 학습 콘텐츠를 확인하고<br>스피킹 과제를 수행하면 됩니다. 단, 습관을 만들기 위해서는<br>매일 최소 20분 이상은 반드시 확보하는 것을 권장드립니다.</p>
        </div>
    </section>
    ...
    <section class="content-section bg-white">
        <div class="section-inner cta-section">
            ...
            <a href="https://pf.kakao.com/_elxhdl" target="_blank" class="kakao-button">
                <img src="resources/KakaoTalk_logo.png" alt="KakaoTalk">
                카카오 문의
            </a>
        </div>
    </section>
                ...
                <div class="footer-left">
                    ...
                    <div class="footer-social">
                        ...
                        <a href="https://blog.naver.com/pweng8672" target="_blank" aria-label="Blog">
                            <img src="resources/blog.png" alt="Blog">
                        </a>
                    </div>
